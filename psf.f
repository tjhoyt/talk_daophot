...
C
      ...
      INTEGER NOPT
      PARAMETER  (MAXPAR=6, MAXPSF=407, MAXEXP=10) 
      PARAMETER  (MAXSTR=800 000, MAXN=1500) 
C
C Parameters
C
...
C
      IF (STAROK) THEN
         ...
         END IF
      ELSE IF (SATUR8) THEN
         CALL STUPID ('This star is saturated.')
         GO TO 2000
      ELSE
